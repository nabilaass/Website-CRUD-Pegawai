		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-2 pb-2 mb-2 d-flex">
					<div class="image">
						<img src="dist/img/userr.png" class="img-circle elevation-1" alt="User Image">
					</div>
					<div class="info">
    ...
    ?>
		...
		<footer class="main-footer">
			<div class="float-right d-none d-sm-block">
				Copyright &copy;
				<a target="_blank" href="https://www.youtube.com/channel/UCUuiObJ6X-J1mRmZV7NT-cg">
					<strong> politeknik harapan bersama kota tegal</strong>
				</a>
			</div>
		</footer>
