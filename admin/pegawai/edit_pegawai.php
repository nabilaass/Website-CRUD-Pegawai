	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
                ...
                else echo "<option value='PNS'>Pegawai PNS</option>";

                if ($data_cek['status'] == "GTT") echo "<option value='GTT' selected>GTT</option>";
                else echo "<option value='GTT'>Pegawai GTT</option>";
            			?>
					</select>
				</div>
			</div>
